...
Route::middleware(["auth", "auth.session", "permission:create-team"])->post("team", [TeamController::class, "createTeam"])->name("doCreateTeam");
...
Route::middleware(["auth", "auth.session", "userInTeam", "permission:delete-team"])->post("team/{team_id}/delete", [TeamController::class, "deleteTeam"])->name("doDeleteTeam");
Route::middleware(["auth", "auth.session", "userInTeam"])->post("team/{team_id}/leave", [TeamController::class, "leaveTeam"])->name("doLeaveTeam");
Route::middleware(["auth", "auth.session", "userInTeam", "permission:send-invitation"])->post("team/{team_id}/invite", [TeamController::class, "inviteMembers"])->name("doInviteMembers");
...
Route::middleware(["auth", "auth.session", "userInTeam", "permission:manage-members"])->post("team/{team_id}/user/delete", [TeamController::class, "deleteMembers"])->name("deleteTeamMember");
Route::middleware(["auth", "auth.session", "userInTeam"])->get("team/{team_id}/view", [TeamController::class, "showTeam"])->name("viewTeam");
Route::middleware(["auth", "auth.session", "userInTeam", "permission:update-team"])->post("team/{team_id}/update/profile", [TeamController::class, "updateData"])->name("doTeamDataUpdate");
Route::middleware(["auth", "auth.session", "userInTeam", "permission:update-team"])->post("team/{team_id}/update/picture", [TeamController::class, "updateImage"])->name("doChangeTeamImage");
...
Route::middleware(["auth", "auth.session", "boardAccess", "permission:create-task"])->post("team/{team_id}/board/{board_id}/column/{column_id}/card", [BoardController::class, "addCard"])->name("addCard");
Route::middleware(["auth", "auth.session", "boardAccess", "permission:edit-task"])->post("team/{team_id}/board/{board_id}/column/reorder", [BoardController::class, "reorderCol"])->name("reorderCol");
Route::middleware(["auth", "auth.session", "boardAccess", "permission:edit-task"])->post("team/{team_id}/board/{board_id}/column/update", [BoardController::class, "updateCol"])->name("updateCol");
Route::middleware(["auth", "auth.session", "boardAccess", "permission:delete-task"])->post("team/{team_id}/board/{board_id}/column/delete", [BoardController::class, "deleteCol"])->name("deleteCol");
Route::middleware(["auth", "auth.session", "boardAccess", "permission:edit-task"])->post("team/{team_id}/board/{board_id}/card/reorder", [BoardController::class, "reorderCard"])->name("reorderCard");
...
Route::middleware(["auth", "auth.session", "boardAccess", "cardExist", "permission:assign-tasks"])->post("team/{team_id}/board/{board_id}/card/{card_id}/assign", [CardController::class, "assignCard"])->name("assignCard");
Route::middleware(["auth", "auth.session", "boardAccess", "cardExist", "permission:assign-tasks"])->post("team/{team_id}/board/{board_id}/card/{card_id}/assignTask", [CardController::class, "assignTask"])->name("assignTask");
Route::middleware(["auth", "auth.session", "boardAccess", "cardExist", "permission:assign-tasks"])->post("team/{team_id}/board/{board_id}/card/{card_id}/unassignTask", [CardController::class, "unassignTask"])->name("unassignTask");
...
Route::middleware(["auth", "auth.session", "boardAccess", "cardExist", "permission:delete-task"])->post("team/{team_id}/board/{board_id}/card/{card_id}/delete", [CardController::class, "deleteCard"])->name("deleteCard");
Route::middleware(["auth", "auth.session", "boardAccess", "cardExist", "permission:archive-task"])->post("team/{team_id}/board/{board_id}/card/{card_id}/do-archive", [CardController::class, "archiveCard"])->name("doArchiveCard");
Route::middleware(["auth", "auth.session", "boardAccess", "cardExist", "permission:archive-task"])->post("team/{team_id}/board/{board_id}/card/{card_id}/do-unarchive", [CardController::class, "unarchiveCard"])->name("doUnarchiveCard");
Route::middleware(["auth", "auth.session", "boardAccess", "cardExist", "permission:edit-task"])->post("team/{team_id}/board/{board_id}/card/{card_id}/update", [CardController::class, "updateCard"])->name("updateCard");
