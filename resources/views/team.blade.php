                ...
                <div class="flex flex-col w-full gap-2" id="invite-container">
                    ...
                    {{-- <div class="flex gap-2" id="email-tag-1">
                                ...
                                <x-form.button outline type="button" action="DOM.find('#email-tag-1')?.remove()"
                                    class="!border-2 !text-sm w-min !px-4 text-red-600">
        ...
        function handleInsert() {
            ...
            let emailtag = DOM.create(`
                    <div class="flex gap-2" id="email-tag-${id}">
                        ...
                        <button onclick="DOM.find('#email-tag-${id}')?.remove()" type="button" class="flex items-center justify-center w-full gap-2 px-6 py-1 text-base font-bold border-4 border-red-700 rounded-full bg-white text-red-600 hover:bg-red-600 hover:text-white !border-2 !text-sm w-min !px-4">
