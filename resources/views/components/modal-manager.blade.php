<div id="modal-view" data-role="modal-manager-container"
    class="fixed z-40 flex flex-wrap items-center justify-center w-screen h-screen overflow-y-auto bg-[#0a2436] bg-opacity-50 backdrop-blur-sm"
    style="display: none">

    <div class="min-w-[40rem] max-w-[70%] max-h-[70%] flex flex-col bg-white rounded-xl overflow-y-auto">
